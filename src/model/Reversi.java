...
public interface Reversi extends ReversiReadOnly {
   ...
   *
   * @return A {@link HashMap} representing a copy of the board. Each {@link Coordinate} key is mapped to a {@link Cell} value.
   */
   ...
   *
   * @return An {@link ArrayList} of {@link Coordinate} objects representing all possible moves that the current player can make.
   */
